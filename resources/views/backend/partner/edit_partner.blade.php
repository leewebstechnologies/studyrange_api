    ...
    <div class="container-xxl">
        ...
        <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
            <div class="flex-grow-1">
                <h4 class="fs-18 fw-semibold m-0">Edit University Partner</h4>
            </div>
        </div>
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Edit University Partner</h5>
                    </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('update.partner') }}" method="post" class="row g-3" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="rank" class="form-control" value="{{ $partner->rank }}">
                            </div>
