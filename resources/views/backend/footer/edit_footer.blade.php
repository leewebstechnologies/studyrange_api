    ...
    <div class="container-xxl">
        ...
        <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
            <div class="flex-grow-1">
                <h4 class="fs-18 fw-semibold m-0">Edit Footer</h4>
            </div>
        </div>
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Edit Footer</h5>
                    </div>

                    <div class="card-body">
                        <form action="{{ route('update.footer') }}" method="post" class="row g-3" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="phone_two" class="form-control" value="{{ $footer->phone_two }}">
                            </div>
