...
Route::get('/resource', [ResourceController::class, 'ApiAllResources']);
Route::get('/resourcedetail', [ResourcedetailController::class, 'ApiAllResourcedetails']);
Route::get('/resourcetutorial', [ResourcetutorialController::class, 'ApiAllResourcetutorials']);
Route::post('/match', [MatchController::class, 'ApiMatch']);
Route::post('/message', [MessageController::class, 'ApiMessage']);
Route::post('/studymatch', [StudymatchController::class, 'ApiStudymatch']);
Route::post('/appointment', [AppointmentController::class, 'ApiAppointment']);
Route::get('/timeslot', [TimeslotController::class, 'ApiAllTimeslots']);
Route::get('/guide', [GuideController::class, 'ApiAllGuides']);
